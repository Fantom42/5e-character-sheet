...
function player_data_load(){
    ...
    fileread.onload = function (e) {
        ...
        document.getElementById("name").value = intern[0].name
        document.getElementById("race").value = intern[0].race
        document.getElementById("class").value = intern[0].character_class
        document.getElementById("mhp").value = intern[0].maxhp
        document.getElementById("pass_percep").value = intern[0].passive_perception
        document.getElementById("prof_bonus").value = intern[0].profficiency_bonus
        document.getElementById("initiative").value = intern[0].initiative
    
        document.getElementById("str").value = intern[1].str
        document.getElementById("str_bonus").value = intern[1].str_bonus
        document.getElementById("athl").value = intern[1].athletics
        document.getElementById("int").value = intern[1].int
        document.getElementById("int_bonus").value = intern[1].int_bonus
        document.getElementById("arc").value = intern[1].arcana
        document.getElementById("his").value = intern[1].history
        document.getElementById("inv").value = intern[1].investigation
        document.getElementById("nat").value = intern[1].nature
        document.getElementById("reli").value = intern[1].religion
        document.getElementById("wis").value = intern[1].wis
        document.getElementById("wis_bonus").value = intern[1].wis_bonus
        document.getElementById("anhan").value = intern[1].animal_handling
        document.getElementById("ins").value = intern[1].insight
        document.getElementById("med").value = intern[1].medicine
        document.getElementById("percep").value = intern[1].perception
        document.getElementById("surv").value = intern[1].survival
        document.getElementById("dex").value = intern[1].dex
        document.getElementById("dex_bonus").value = intern[1].dex_bonus
        document.getElementById("acro").value = intern[1].acrobatics
        document.getElementById("stea").value = intern[1].stealth
        document.getElementById("soh").value = intern[1].sleight_of_hand
        document.getElementById("cha").value = intern[1].cha
        document.getElementById("cha_bonus").value = intern[1].cha_bonus
        document.getElementById("pers").value = intern[1].persuation
        document.getElementById("dec").value = intern[1].deception
        document.getElementById("inti").value = intern[1].intimidation
        document.getElementById("perf").value = intern[1].performance
        document.getElementById("con").value = intern[1].con
        document.getElementById("con_bonus").value = intern[1].con_bonus
    
        document.getElementById("traits").value = intern[1].traits
    
        document.getElementById("plat").value = intern[2].plat
        document.getElementById("gold").value = intern[2].gold
        document.getElementById("elec").value = intern[2].elec
        document.getElementById("silv").value = intern[2].silv
        ...
        document.getElementById("lvl3spells").value = intern[3].lvl3spells
        document.getElementById("lvl4spells").value = intern[3].lvl4spells
        document.getElementById("lvl5spells").value = intern[3].lvl5spells
        document.getElementById("lvl6spells").value = intern[3].lvl6spells
        document.getElementById("lvl7spells").value = intern[3].lvl7spells
        document.getElementById("lvl8spells").value = intern[3].lvl8spells
        document.getElementById("lvl9spells").value = intern[3].lvl9spells
    }
